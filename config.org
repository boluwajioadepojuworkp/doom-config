...
#+author: Boluwaji Oluwaseyi Adepoju
...
#+begin_src emacs-lisp
;; credentials
(setq user-full-name "Boluwaji Oluwaseyi Adepoju"
      user-mail-address "boluwajio.adepojuworkp@gmail.com")
...
#+ATTR_ORG: :width 500
[[https://raw.githubusercontent.com/boluwajioadepojuworkp/doom-config/main/images/gruvbox-colorscheme.png]]
...
*** doom-dashboard
#+ATTR_ORG: :width 350
[[https://raw.githubusercontent.com/boluwajioadepojuworkp/doom-config/main/images/dashboard.png]]
...
[[https://raw.githubusercontent.com/boluwajioadepojuworkp/doom-config/main/images/modeline.png]]
...
[[https://raw.githubusercontent.com/boluwajioadepojuworkp/doom-config/main/images/whitespace.png]]
...
[[https://raw.githubusercontent.com/boluwajioadepojuworkp/doom-config/main/images/latex-preview.png]]
...
;; ── Capture Templates ──────────────────────────────────────────────
;; Evidence-based note templates for course notes, math, and evergreen notes.
;; Structure: Week → Lecture → Topics  OR  Chapter → Topics
...
(setq org-roam-capture-templates
      `(("d" "default" plain "%?"
        ...
        ("p" "permanent/evergreen note" plain
         ,(concat
           "#+title: ${title}\n"
           "#+filetags: :evergreen:\n"
           "#+date: %<%Y-%m-%d>\n"
...
;; ── Daily Notes ─────────────────────────────────────────────────────
;; End-of-day retrieval practice: write what you remember from lectures.
...
(map! :leader
      (:prefix ("r" . "roam")
       ...
       :desc "Daily note"    "j" #'org-roam-dailies-capture-today
       :desc "Yesterday"     "y" #'org-roam-dailies-goto-yesterday
       :desc "Tomorrow"      "m" #'org-roam-dailies-goto-tomorrow
       :desc "Find directory" "d" #'org-roam-dailies-find-directory
       :desc "Random note"   "r" #'org-roam-node-random))

;; ── Note Export to Quartz Knowledge Graph ───────────────────────────
;; Org-roam notes → Markdown for the Quartz static site.
;; The notes-site/content/ directory mirrors org-roam structure.

(defun my/org-roam-export-to-quartz ()
  "Export current org-roam buffer to Markdown in the Quartz content directory."
  (interactive)
  (when (and (fboundp 'org-roam-buffer-p) (org-roam-buffer-p))
    (let* ((org-file (buffer-file-name))
           (md-file (concat (file-name-sans-extension
                             (replace-regexp-in-string
                              (expand-file-name org-roam-directory)
                              (expand-file-name "~/ME/notes-site/content")
                              org-file))
                            ".md")))
      (make-directory (file-name-directory md-file) t)
...
(map! :map org-roam-mode-map
      :leader
      (:prefix ("r" . "roam")
       :desc "Export to Quartz" "e" #'my/org-roam-export-to-quartz))
#+end_src
